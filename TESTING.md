...
The originally-proposed audit plan had six areas; five have real findings or a clean pass documented above (network exposure, static analysis, privilege scoping, systemd sandboxing, file permissions). Still open:
...
- PIN lock brute-force resistance under a real process restart - does the attempt counter (if any) reset on restart, making rate-limiting bypassable by anyone who can trigger a crash/restart?
